...
import Modelo.LogueoAUX;
import javax.swing.JOptionPane;


public class Registar_Usuario extends javax.swing.JFrame {
   Logueo lg = new Logueo();
   LogueoAUX login = new LogueoAUX();
    public Registar_Usuario() {
        initComponents();
    }
    public void validar_ingreso(){
        String Nombre_Usuario = LNombreUsuario.getText();
        String Contraseña = String.valueOf(LPass.getPassword());
        if (!"".equals(Nombre_Usuario) || !"".equals(Contraseña)){
            lg.setNombre_Usuario(Nombre_Usuario);
            lg.setContraseña(Contraseña);
            login.registrar_usuario(lg);
                Inicio_Sesion home = new Inicio_Sesion();
    ...
    private void initComponents() {
        ...
        LNombreUsuario = new javax.swing.JTextField();
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(LNombreUsuario, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(LNombreUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22)
    ...
    private javax.swing.JTextField LNombreUsuario;
